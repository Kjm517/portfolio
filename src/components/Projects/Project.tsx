      ...
      <div className="max-w-7xl mx-auto px-4 pb-16">
        <div className="flex flex-col lg:flex-row gap-6 min-h-[600px]">
          ...
          <motion.div
            ...
            className="w-full lg:w-[380px] flex-shrink-0 bg-white dark:bg-gray-900 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-800 flex flex-col overflow-hidden"
          >
            {/* Header */}
          ...
          <motion.div
            ...
            className="hidden lg:flex flex-1 bg-white dark:bg-gray-900 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-800 overflow-hidden"
          >
                    ...
                    <div className="absolute top-4 right-4 flex gap-2">
                      {selectedProject.github_url && (
                        <a
                          ...
                          className="px-3 py-1.5 bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm rounded-lg flex items-center gap-1.5 hover:bg-white transition-colors"
                        >
      ...
      <AnimatePresence>
        {isMobileDetailOpen && selectedProject && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="lg:hidden fixed inset-0 z-50 bg-white dark:bg-gray-950"
          >
            {/* Close Button */}
            <button
              onClick={() => setIsMobileDetailOpen(false)}
              className="absolute top-4 left-4 z-10 w-10 h-10 bg-white dark:bg-gray-900 shadow-lg rounded-full flex items-center justify-center border border-gray-200 dark:border-gray-800"
            >
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {selectedProject.technologies?.map((tech, index) => (
                    <span
                      ...
                      className="px-3 py-1.5 bg-gray-100 dark:bg-gray-900 text-gray-700 dark:text-gray-300 rounded-lg text-sm"
                    >
                      {tech}
                    </span>
                  ))}
